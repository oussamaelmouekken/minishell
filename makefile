...
CEXE = main.c  builtins/cd.c builtins/pwd.c builtins/env.c builtins/echo_n.c builtins/unset.c builtins/export.c execution/execute.c execution/utils_ex.c execution/herdoc.c
